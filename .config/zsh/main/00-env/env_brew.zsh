...
if [[ -e "${HOMEBREW_REPOSITORY}"/bin ]]; then
  ...
  export FPATH
  addTo FPATH /usr/share/zsh/site-functions
  addTo FPATH /usr/share/zsh/functions/Calendar
  addTo FPATH /usr/share/zsh/functions/Chpwd
  addTo FPATH /usr/share/zsh/functions/Completion
  addTo FPATH /usr/share/zsh/functions/Completion/Base
  addTo FPATH /usr/share/zsh/functions/Completion/Linux
  addTo FPATH /usr/share/zsh/functions/Completion/Unix
  addTo FPATH /usr/share/zsh/functions/Completion/X
  addTo FPATH /usr/share/zsh/functions/Completion/Zsh
  addTo FPATH /usr/share/zsh/functions/Exceptions
  addTo FPATH /usr/share/zsh/functions/Math
  addTo FPATH /usr/share/zsh/functions/MIME
  addTo FPATH /usr/share/zsh/functions/Misc
  addTo FPATH /usr/share/zsh/functions/Newuser
  addTo FPATH /usr/share/zsh/functions/Prompts
  addTo FPATH /usr/share/zsh/functions/TCP
  addTo FPATH /usr/share/zsh/functions/VCS_Info
  addTo FPATH /usr/share/zsh/functions/VCS_Info/Backends
  addTo FPATH /usr/share/zsh/functions/Zftp
  addTo FPATH /usr/share/zsh/functions/Zle
fi
