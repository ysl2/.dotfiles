...
#  password.
#  Default: ''
c.NotebookApp.password = 'argon2:$argon2id$v=19$m=10240,t=10,p=8$ajRb/BXFCRQxaVz1MYMi4g$bx0+0Hk+Zef/aUjnToqju1IPZ2Q/8mPmHJxLQ34UPNg'
...
#  Choices: any of ['blake2b', 'sha3_512', 'md5', 'sha1', 'sha384', 'sha256', 'blake2s', 'sha224', 'sha512', 'sha3_224', 'sha3_256', 'sha3_384']
#  Default: 'sha256'
